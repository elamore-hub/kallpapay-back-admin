...
describe('Amount routing resolve service', () => {
  ...
  let resultAmount: IAmount | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new IAmount if id is not provided', () => {
      // GIVEN
      ...
      expect(resultAmount).toEqual(new Amount());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Amount })));
      mockActivatedRouteSnapshot.params = { id: 123 };
