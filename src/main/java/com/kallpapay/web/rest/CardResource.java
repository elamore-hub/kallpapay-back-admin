...
/**
 * REST controller for managing {@link com.kallpapay.domain.Card}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Card> result = cardRepository
            ...
            .map(existingCard -> {
                if (card.getExternalId() != null) {
                    existingCard.setExternalId(card.getExternalId());
                }
                if (card.getType() != null) {
                    existingCard.setType(card.getType());
                }
                if (card.getMainCurrency() != null) {
                    existingCard.setMainCurrency(card.getMainCurrency());
                }
                if (card.getCardDesignUrl() != null) {
                    existingCard.setCardDesignUrl(card.getCardDesignUrl());
                }
                if (card.getCardUrl() != null) {
                    existingCard.setCardUrl(card.getCardUrl());
                }
