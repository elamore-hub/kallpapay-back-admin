...
import com.kallpapay.domain.BankAccount;
import com.kallpapay.repository.BankAccountRepository;
...
/**
 * REST controller for managing {@link com.kallpapay.domain.BankAccount}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<BankAccount> partialUpdateBankAccount(
        ...
        Optional<BankAccount> result = bankAccountRepository
            ...
            .map(existingBankAccount -> {
                if (bankAccount.getExternalId() != null) {
                    existingBankAccount.setExternalId(bankAccount.getExternalId());
                }
                ...
                if (bankAccount.getLanguage() != null) {
                    existingBankAccount.setLanguage(bankAccount.getLanguage());
                }
