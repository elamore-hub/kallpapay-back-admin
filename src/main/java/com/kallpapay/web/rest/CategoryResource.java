...
import com.kallpapay.domain.Category;
import com.kallpapay.repository.CategoryRepository;
...
/**
 * REST controller for managing {@link com.kallpapay.domain.Category}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Category> result = categoryRepository
            ...
            .map(existingCategory -> {
                ...
                if (category.getLogo() != null) {
                    existingCategory.setLogo(category.getLogo());
                }
                if (category.getLogoContentType() != null) {
                    existingCategory.setLogoContentType(category.getLogoContentType());
                }
