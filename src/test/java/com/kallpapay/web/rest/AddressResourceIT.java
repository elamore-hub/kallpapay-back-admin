...
import com.kallpapay.repository.AddressRepository;
...
class AddressResourceIT {
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.addressLine2(UPDATED_ADDRESS_LINE_2).city(UPDATED_CITY).postalCode(UPDATED_POSTAL_CODE).state(UPDATED_STATE);
