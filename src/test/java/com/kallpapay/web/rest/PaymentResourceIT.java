...
import com.kallpapay.domain.Payment;
import com.kallpapay.repository.PaymentRepository;
...
class PaymentResourceIT {
    ...
    public static Payment createEntity(EntityManager em) {
        Payment payment = new Payment().externalId(DEFAULT_EXTERNAL_ID).status(DEFAULT_STATUS);
        return payment;
    }
    ...
    public static Payment createUpdatedEntity(EntityManager em) {
        Payment payment = new Payment().externalId(UPDATED_EXTERNAL_ID).status(UPDATED_STATUS);
        return payment;
    }
    ...
    void createPayment() throws Exception {
        ...
        assertThat(testPayment.getExternalId()).isEqualTo(DEFAULT_EXTERNAL_ID);
    ...
    void putNewPayment() throws Exception {
        ...
        updatedPayment.externalId(UPDATED_EXTERNAL_ID).status(UPDATED_STATUS);
        ...
        Payment testPayment = paymentList.get(paymentList.size() - 1);
        assertThat(testPayment.getExternalId()).isEqualTo(UPDATED_EXTERNAL_ID);
    ...
    void fullUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.externalId(UPDATED_EXTERNAL_ID).status(UPDATED_STATUS);
